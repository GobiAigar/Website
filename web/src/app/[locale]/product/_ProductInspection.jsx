			...
			>
				<Container>
					<Grid container size={12} justifyContent={"space-between"}>
						<Grid
							size={{ xs: 12, sm: 5.8, md: 2.9 }}
							sx={{ padding: { xs: 0, sm: 4, md: 0 }, paddingBottom: { sm: 0 } }}
						>
							<Box
								display={"flex"}
								flexDirection={"column"}
							...
							>
								...
								<Typography variant="body1">{lang === "mn" ? "Урт" : "Length"}</Typography>
							</Box>
						</Grid>
						...
						>
							...
							>
								...
								<Typography variant="body1">{lang === "mn" ? "Микрон" : "Micron"}</Typography>
							</Box>
						</Grid>

						<Grid size={{ xs: 12, sm: 5.8, md: 2.9 }} sx={{ padding: { xs: 0, sm: 4, md: 0 }, paddingTop: { sm: 0 } }}>
							<Box
								display={"flex"}
								flexDirection={"column"}
								justifyContent={"center"}
							...
							>
								...
								<Typography variant="body1">{lang === "mn" ? "Хаг" : "Dandruff"}</Typography>
							</Box>
						</Grid>
						...
						<Grid size={{ xs: 12, sm: 5.8, md: 2.9 }} sx={{ padding: { xs: 0, sm: 4, md: 0 }, paddingTop: { sm: 0 } }}>
							...
							>
								<Typography variant="h3">-0.2%</Typography>
								<Typography variant="body1">{lang === "mn" ? "Бүдүүн хялгас" : "Coarse Hair"}</Typography>
							</Box>
						</Grid>
					</Grid>
				</Container>
